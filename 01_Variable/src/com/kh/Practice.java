...
public class Practice {
	...
	public static void example01() {
		...
		// 변수를 사용한 경우 (아래에 작성)
		int year = 2023;	// 정수형 year 변수에 2023 값 초기화
		int age = 36;		// 정수형 age 변수에 36 값 초기화
	...
	public static void example02() {
		...
		int _1num = 10;
		System.out.println("1num의 값은 " + _1num + "입니다.");
		
		
		// 아래는 변수 제약 사항 중 ( 4 )에 해당되어 오류가 발생.		
		boolean b_reak = true;
		System.out.println("논리형 자료형 변수인 b_reak 의 값은 " + b_reak + "입니다.");
		...
		// 위의 System.out.println 의 출력 결과는? 20, 15
	...
	public static void example04() {
		...
		System.out.println("해당 놀이기구는 " + MAX_WEIGHT + "키로 이상 탑승 금지!");
	}
	...
	public static void example06() {
		...
		// 사용자로부터 키 입력 받기
		double h = sc.nextDouble();	// 키를 보관하기 위한 변수
//		h = sc.nextDouble();	    // 사용자 입력받은 값을 h 변수에 보관(대입)
		
		// 사용자에게 몸무게를 입력받기 위해 "원하는 몸무게를 입력해주세요: "를 화면에 출력
		System.out.print("원하는 몸무게를 입력해주세요: ");
		
		// 사용자로부터 몸무게 입력 받기
		int w = sc.nextInt();		// 사용자 입력받은 값을 w 변수에 보관(대입)
		
		
		// 화면에 결과 출력 (예시 참고)
		System.out.println("내가 원하는 키는 " + h + "cm 이고, 몸무게는 " + w + "kg 입니다.");
